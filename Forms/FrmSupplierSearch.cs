...
namespace ChickenDist.Forms
{
    ...
    public class FrmSupplierSearch : Form
    {
        ...
        private void InitUI()
        {
            ...
            txtSearch = new TextBox { Location = new Point(20, 18), Width = 560, BackColor = Color.White, ForeColor = Color.FromArgb(15, 23, 42), BorderStyle = BorderStyle.FixedSingle, Font = new Font("Segoe UI", 12f) };
