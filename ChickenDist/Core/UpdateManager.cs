...
namespace ChickenDist.Core
{
    public static class UpdateManager
    {
        ...
        public const string CurrentVersion = "1.9.10";
        ...
        public static void CheckForUpdates(bool showNoUpdateMsg = false)
        {
            try
            {
                using (var client = new WebClient())
                {
                    ...
                    string downloadUrl   = "";
                    string changelog     = "";
                    string expectedSha256 = ""; // FIX: checksum Ù„Ù„ØªØ­Ù‚Ù‚ Ù…Ù† Ø³Ù„Ø§Ù…Ø© Ø§Ù„Ù…Ù„Ù
        ...
        // â”€â”€ Ø§Ù„ØªØ­Ù‚Ù‚ Ù…Ù† SHA-256 â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€
        ...
        private static void PerformUpdate(string downloadUrl, string remoteVersion, string expectedSha256)
        {
            ...
            // Ø§Ù„ÙƒÙˆØ¯ Ø§Ù„Ù‚Ø¯ÙŠÙ… ÙƒØ§Ù† ÙŠÙØ¬Ù…Ù‘Ø¯ Ø§Ù„Ù€ UI Thread Ø·ÙˆØ§Ù„ Ù…Ø¯Ø© Ø§Ù„ØªØ­Ù…ÙŠÙ„ Ù…Ø¹ Thread.Sleep Ø¹Ù„Ù‰ UI
                    ...
                    for (int attempt = 1; attempt <= maxRetries; attempt++)
                    {
                        try
                        {
                            ...
                            using (var client = new WebClient())
                            {
                                ...
                                // DownloadFileAsync + AutoResetEvent Ù„ØªØ­ÙˆÙŠÙ„ async â†’ sync ÙÙŠ background thread
                                ...
                                done.WaitOne(); // Ù†Ù†ØªØ¸Ø± ÙÙŠ Ø§Ù„Ù€ background thread â€” Ù„Ø§ ÙŠÙØ¬Ù…Ù‘Ø¯ Ø§Ù„Ù€ UI
