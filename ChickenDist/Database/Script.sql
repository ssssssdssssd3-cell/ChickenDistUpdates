...
ALTER DATABASE PartsDist SET RECOVERY SIMPLE
GO
...
-- ========================================
-- الموردين (يجب إنشاؤها قبل Expenses)
-- ========================================
...
-- بيانات ابتدائية
-- ========================================
-- مدير النظام الافتراضي (كلمة المرور المشفّرة: 1)
-- ملاحظة: عند أول تسجيل دخول بكلمة المرور '1' سيتم ترقيتها تلقائياً إلى hash
