...
namespace ChickenDist.Forms
{
	public class FrmReports : Form
	{
		...
		private void InitUI()
		{
			...
			panel.Controls.AddRange(new Control[] { dtpFrom, label, dtpTo, label2, cboWarehouse, lblWh, txtSearchClient, lblSearchClient, btnLoad, btnPrint, btnWhatsAppReport, btnExportExcel });
