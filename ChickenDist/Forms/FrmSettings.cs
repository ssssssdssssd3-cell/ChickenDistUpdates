...
namespace ChickenDist.Forms
{
    public class FrmSettings : Form
    {
        ...
        public FrmSettings()
        {
            ...
            {
                "Ø³ÙˆØ¨Ø± Ù…Ø§Ø±ÙƒØª (Ø§Ù„Ù…ÙˆØ§Ø¯ Ø§Ù„ØºØ°Ø§Ø¦ÙŠØ© ÙˆØ§Ù„ØµÙ„Ø§Ø­ÙŠØ©)",
                "Ù‚Ø·Ø¹ ØºÙŠØ§Ø± Ø³ÙŠØ§Ø±Ø§Øª (Ø£Ø±Ù‚Ø§Ù… Ù‚Ø·Ø¹ OEM ÙˆØ§Ù„Ù…ÙˆØ¯ÙŠÙ„Ø§Øª)",
                "Ù…ÙˆØ¨Ø§ÙŠÙ„Ø§Øª ÙˆØ£Ø¬Ù‡Ø²Ø© Ø°ÙƒÙŠØ© (IMEIØŒ Ø§Ù„Ù„ÙˆÙ†ØŒ Ø´Ø§Ø´Ø© ØµÙŠØ§Ù†Ø©)",
                "Ù…Ù„Ø§Ø¨Ø³ ÙˆØ£Ø­Ø°ÙŠØ© (Ø§Ù„Ù…Ù‚Ø§Ø³ØŒ Ø§Ù„Ù„ÙˆÙ†ØŒ Ø§Ù„Ø®Ø§Ù…Ø©)",
                "Ù†Ø´Ø§Ø· ØªØ¬Ø§Ø±ÙŠ Ø¹Ø§Ù… / ØªØ¬Ø²Ø¦Ø© (Ø¹Ø§Ù… Ø¨Ø¯ÙˆÙ† Ø®Ø§Ù†Ø§Øª Ù…Ø®ØµØµØ©)",
                "ØºÙŠØ§Ø± Ø²ÙŠØª ÙˆØµÙŠØ§Ù†Ø© Ø³ÙŠØ§Ø±Ø§Øª (Ø£Ø±Ù‚Ø§Ù… Ù„ÙˆØ­Ø§ØªØŒ ÙØ­ØµØŒ ÙƒØ±ÙˆØª ØµÙŠØ§Ù†Ø©)"
            });
            cboBusinessType.SelectedItem = AppConfig.BusinessType switch
            {
                "SpareParts" => "Ù‚Ø·Ø¹ ØºÙŠØ§Ø± Ø³ÙŠØ§Ø±Ø§Øª (Ø£Ø±Ù‚Ø§Ù… Ù‚Ø·Ø¹ OEM ÙˆØ§Ù„Ù…ÙˆØ¯ÙŠÙ„Ø§Øª)",
                "Mobiles"    => "Ù…ÙˆØ¨Ø§ÙŠÙ„Ø§Øª ÙˆØ£Ø¬Ù‡Ø²Ø© Ø°ÙƒÙŠØ© (IMEIØŒ Ø§Ù„Ù„ÙˆÙ†ØŒ Ø´Ø§Ø´Ø© ØµÙŠØ§Ù†Ø©)",
                "Clothing"   => "Ù…Ù„Ø§Ø¨Ø³ ÙˆØ£Ø­Ø°ÙŠØ© (Ø§Ù„Ù…Ù‚Ø§Ø³ØŒ Ø§Ù„Ù„ÙˆÙ†ØŒ Ø§Ù„Ø®Ø§Ù…Ø©)",
                "General"    => "Ù†Ø´Ø§Ø· ØªØ¬Ø§Ø±ÙŠ Ø¹Ø§Ù… / ØªØ¬Ø²Ø¦Ø© (Ø¹Ø§Ù… Ø¨Ø¯ÙˆÙ† Ø®Ø§Ù†Ø§Øª Ù…Ø®ØµØµØ©)",
                "CarService" => "ØºÙŠØ§Ø± Ø²ÙŠØª ÙˆØµÙŠØ§Ù†Ø© Ø³ÙŠØ§Ø±Ø§Øª (Ø£Ø±Ù‚Ø§Ù… Ù„ÙˆØ­Ø§ØªØŒ ÙØ­ØµØŒ ÙƒØ±ÙˆØª ØµÙŠØ§Ù†Ø©)",
                _            => "Ø³ÙˆØ¨Ø± Ù…Ø§Ø±ÙƒØª (Ø§Ù„Ù…ÙˆØ§Ø¯ Ø§Ù„ØºØ°Ø§Ø¦ÙŠØ© ÙˆØ§Ù„ØµÙ„Ø§Ø­ÙŠØ©)"
            };
