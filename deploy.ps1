...
$changelogText = "v$VERSION - $([System.DateTime]::Now.ToString('yyyy-MM-dd')): Add discount vouchers system (POS, Sale, Store) and monthly subscription lock for online orders screen"
