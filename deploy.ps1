...
# ─────────────────────────────────────────────
$VERSION   = "1.3.0"
$CHANGELOG = "v1.3.0: (1) إضافة دعم الميزان الإلكتروني — قراءة الوزن تلقائياً عبر COM Port في فاتورة المبيعات مع عرض الوزن لحظياً. (2) دعم باركود الوزن من الميزان — يتعرف على الباركود ويضع الكمية تلقائياً. (3) إضافة الطابعة الحرارية المباشرة — Xprinter وZebra بدون معاينة، دعم ورق 58 و80 مم. (4) صلاحية إظهار التكلفة وهامش الربح — تحكم كامل لكل موظف."
