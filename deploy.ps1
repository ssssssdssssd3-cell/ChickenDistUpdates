...
$changelogText = "v$VERSION - $([System.DateTime]::Now.ToString('yyyy-MM-dd')): Instant application startup and exit optimizations, eliminating 30s shutdown and startup delays"
