...
$changelogText = "v$VERSION - $([System.DateTime]::Now.ToString('yyyy-MM-dd')): Fix purchase price in product card after purchases, fix warehouse transfer Factor error, and enhance transfer product search auto-add"
