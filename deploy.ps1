...
$changelogText = "v$VERSION - $([System.DateTime]::Now.ToString('yyyy-MM-dd')): Added Discount Vouchers and Incomplete Invoices to user permissions, renamed to Incomplete Invoices"
