...
$changelogText = "v$VERSION - $([System.DateTime]::Now.ToString('yyyy-MM-dd')): Guaranteed Admin settings visibility on top bar, removed standalone online orders icon (accessed via Sales), and optimized bar layout"
